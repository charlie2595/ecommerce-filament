                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:border-gray-900 dark:bg-gray-900">
                        ...
                        <ul>
                            ...
                            <li class="mb-4" wire:key="{{ $category->id }}">
                                ...
                                <input type="checkbox" wire:model.live="selectedCategory" id="{{ $category->slug }}" value="{{ $category->id }}" class="w-4 h-4 mr-2">
                        ...
                        <ul>
                            ...
                            <li class="mb-4" wire:key="{{ $brand->id }}">
                                <label for="{{ $brand->slug }}" class="flex items-center dark:text-gray-300">
                                    <input type="checkbox" wire:model.live="selectedBrand" id="{{ $brand->slug }}" value="{{ $brand->id }}" class="w-4 h-4 mr-2">
                        ...
                        <ul>
                            <li class="mb-4">
                                <label for="featured" class="flex items-center dark:text-gray-300">
                                    <input type="checkbox" id="featured" wire:model.live="popular" value="1" class="w-4 h-4 mr-2">
                                    <span class="text-lg dark:text-gray-400">In Popular</span>
                                </label>
                            </li>
                            <li class="mb-4">
                                <label for="on_sale" class="flex items-center dark:text-gray-300">
                                    <input type="checkbox" id="on_sale" wire:model.live="onSale" value="1" class="w-4 h-4 mr-2">
                            ...
                            <div class="border border-gray-300 dark:border-gray-700">
                                <div class="relative bg-gray-200">
                                    <a href="/products/{{ $product->slug }}" class="">
                                        <img src="{{ url('storage', $product->thumbnail) }}" alt="{{ $product->name }}" class="object-cover w-full h-56 mx-auto ">
                                    </a>
                                </div>
                                <div class="p-3 ">
